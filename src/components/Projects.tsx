      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {projects.map((project, index) => (
            <div key={index} className="pixel-card bg-white/90 dark:bg-slate-700/90 p-6 hover:scale-105 transition-transform">
              <div className="flex justify-between items-start mb-4">
                <h3 className="text-xl font-bold text-cyan-600 dark:text-cyan-400">{project.title}</h3>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tech.map((tech, techIndex) => (
                  <span key={techIndex} className="bg-slate-200 dark:bg-slate-700 text-cyan-600 dark:text-cyan-400 px-2 py-1 text-xs font-bold pixel-border">
                    {tech}
                  </span>
                ))}
              </div>
              ...
              <div className="flex gap-3">
                <button className="pixel-button bg-fuchsia-400 dark:bg-fuchsia-500 text-white py-2 px-4 text-sm flex items-center gap-2 hover:scale-105 transition-transform">
                  <Github size={14} />
                  CODE
                </button>
                <button className="pixel-button bg-purple-400 dark:bg-purple-500 text-white py-2 px-4 text-sm flex items-center gap-2 hover:scale-105 transition-transform">
