...
export const About: React.FC = () => {
  return (
    <div className="min-h-[calc(100vh-220px)] py-12 pb-0">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="w-full flex flex-col md:flex-row gap-4 md:gap-8">
          <div className="pixel-card bg-white/90 dark:bg-slate-700/90 p-3 md:p-4 flex-1 flex flex-col justify-center">
            <h3 className="text-lg md:text-xl font-bold text-cyan-600 dark:text-cyan-400 mb-2">MISSION</h3>
          ...
          <div className="pixel-card bg-white/90 dark:bg-slate-700/90 p-3 md:p-4 flex-1 flex flex-col">
            <h3 className="text-lg md:text-xl font-bold text-cyan-600 dark:text-cyan-400 mb-2">WHAT I DO WHEN NOT CODING</h3>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed text-xs md:text-sm">
